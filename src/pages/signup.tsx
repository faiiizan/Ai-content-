   ...
   <Header/>
     ...
     <Container maxWidth='lg'>
       <Grid container sx={{display:"flex",justifyContent:"space-between"}}>
          <Grid xs={12} md={6} sx={{paddingBottom:{xs:"20px",md:"0px"}}} className={Hero.background}>
             <Box sx={{paddingLeft:{sm:"43px",xs:"0px"}}}>
              <Typography sx={{fontSize:{sm:"50.75px",xs:"24px"},fontFamily:"Inter",fontWeight:"600",lineHeight:{sm:"63.51px",xs:"28px",},letterSpacing:"-1.72px",textAlign:{xs:"center",md:"left"}}}>
              ...
              <Typography sx={{paddingTop:{sm:"20px",xs:"12px"},display:"flex",justifyContent:"flex-start",alignItems:"flex-start",color:"#3A3A40",fontFamily:"Inter",lineHeight:"24.14px",fontSize:"15.7px",letterSpacing:"-0.17px",fontWeight:"500",textAlign:"center",paddingLeft:{xs:"20px",md:"0px",sm:"200px"},textAlignLast:{xs:"center",md:"left"}}}>
                <CheckCircleIcon sx={{marginRight:"15px",color:"#D7F200"}}/> Register your account with your <br /> details.
               </Typography>
          ...
          <Grid xs={12} md={6} sx={{display:"flex",justifyContent:{md:"flex-end",xs:"center",}}}>
            <Card sx={{minWidth:{sm:"470px",xs:"335px"},padding:"40px 20px",border:"1.72px solid #DBD9FB",borderRadius:"17.24px",marginRight:"10px",marginLeft:{xs:"15px",sm:"0px"}}} component='form' onSubmit={handleSubmit(onHandleSubmit)}>
              <Box sx={{paddingBottom:"15px"}}>
                <label htmlFor="" style={{fontSize:"14px",fontWeight:"700",fontFamily:"Inter",color:"#000", paddingBottom:"18px!important",marginLeft:"10px"}}>Your Name</label>
                <TextField fullWidth
                     sx={{ 
                      borderRadius: "40px", 
                ...
                {errors?.Your_name && <span style={{fontFamily:"Inter",fontWeight:"400",color:"#F32013",paddingLeft:"15px",paddingTop:"12px",fontSize:"14px"}}>This Field is Required*</span>}
              </Box>
              <Box sx={{paddingBottom:"20px"}}>
                <label htmlFor="" style={{fontSize:"14px",fontWeight:"700",fontFamily:"Inter",color:"#000", paddingBottom:"18px!important",marginLeft:"10px"}}>Email Address</label>
                <TextField fullWidth
                     sx={{ 
                      borderRadius: "40px", 
                      border: "1px solid #ccc", 
              ...
              <Box sx={{paddingBottom:"20px"}}>
                <label htmlFor="" style={{fontSize:"14px",fontWeight:"700",fontFamily:"Inter",color:"#000", paddingBottom:"18px!important",marginLeft:"10px"}}>Confirm Password</label>
                <TextField fullWidth
                     sx={{ 
                      borderRadius: "40px", 
                      border: "1px solid #ccc", 
              ...
              <Typography sx={{paddingTop:"18px",textAlign:"center",fontFamily:"Inter",fontSize:"13.79px",fontWeight:"400"}}>
               Already have an account? <Link href='/login' style={{textDecoration:"none",color:"#2E95FB"}}>Log in</Link>
              </Typography>
            </Card>
          </Grid>
       </Grid>
