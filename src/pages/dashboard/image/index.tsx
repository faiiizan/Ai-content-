                                ...
                                <ul style={{ margin: "0px", padding: "0px" }}>
                                    ...
                                    <li style={{ listStyle: "none" }}>
                                        <Link href='/dashboard/image' style={{ textDecoration: "none" }} passHref>
                                            <Typography sx={{ display: "flex", alignItems: "flex-start", fontFamily: "Poppins", fontSize: "18px", lineHeight: "27px", fontWeight: "400", color: "#737791", paddingTop: "20px", textAlign: "left",  ...getLinkStyle('/dashboard/image') }}>
