            ...
            <Box>
                ...
                <Box sx={{ paddingTop: "15px" }}>
                    <Grid container sx={{ paddingLeft: "0px", paddingRight: "0px" }}>
                        ...
                        <Grid xs={12} sm={12} md={9.5} sx={{ backgroundColor: "#F8F9FA", padding: { xs: "10px", sm: "5px 25px 20px 25px" }, display: "flex", flexDirection: "column" }}>
                            <Grid  >
                                ...
                                <Box sx={{ background: "#fff", padding: "20px", minHeight: "100vh" }}>
                                    ...
                                    <Box sx={{ display: "flex", justifyContent: { sm: "flex-end", xs: "flex-start" }, marginBottom: "50px" }}>
                                        ...
                                        <Grid xs={12}>
                                            <TableContainer component={Paper} sx={{ width: "100%" }}>
                                                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                                    <TableHead>
                                                        <TableRow>
                                                            <TableCell sx={{ fontFamily: "Poppins", fontWeight: "600", fontSize: "18px" }}>Name</TableCell>
                                                            <TableCell align="right" sx={{ fontFamily: "Poppins", fontWeight: "600", fontSize: "18px" }} >Modified</TableCell>
                                                            <TableCell align="right" sx={{ fontFamily: "Poppins", fontWeight: "600", fontSize: "18px" }}>Rename</TableCell>
